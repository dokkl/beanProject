package com.bean.cmd;

import com.bean.cmd.configuration.CmdDomainApplicationContextConfig;
import com.bean.cmd.domain.admin.Authority;
import com.bean.cmd.domain.admin.AuthorityRepository;
import com.bean.cmd.domain.admin.User;
import com.bean.cmd.domain.admin.UserRepository;
import com.bean.cmd.domain.hello.Hello;
import com.bean.cmd.domain.hello.HelloRepository;
import com.bean.cmd.sample.*;
...
@ComponentScan(basePackages={"com.bean.cmd"})
